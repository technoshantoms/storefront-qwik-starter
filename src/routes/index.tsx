		...
		<div>
			<div class="relative h-[200px]">
				<div class="absolute inset-0 overflow-hidden">
					...
					/>
					<div class="absolute inset-0 bg-gradient-to-br from-yellow-500 to-indigo-700 mix-blend-overlay" />
				</div>
				...
				<div class="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
					<div class="relative bg-zinc-800 bg-opacity-0 rounded-lg p-0">
						<h1 class="text-4xl text-transparent bg-clip-text font-extrabold tracking-normal lg:text-4xl bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600">
							{$localize`e-commerce platform`}
						</h1>
					</div>
				</div>
			</div>
					...
					<div class="-my-2">
						<div class="box-content py-2 px-2 relative overflow-x-auto xl:overflow-visible">
							<div class="sm:px-6 lg:px-8 xl:px-0 pb-4">
								<h2 class="text-2xl font-light tracking-tight text-cyan-500">{$localize`Shop by Category`}</h2>
							</div>
